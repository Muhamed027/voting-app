    ...
    <div class="button-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div x-data="{ isOpen: false }" class="relative">
                <button x-on:click="isOpen=!isOpen" x-on:click.away="isOpen=false" x-cloak type="button"
                ...
                <div x-show="isOpen" x-transition.origin.top.left.duration.500ms
                    ...
                    <form action="#" class="space-y-4 py-6 mx-2">
                        <div class="mt-2 space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="form-radio text-gray-500 bg-gray-200" type="radio" checked=""
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="form-radio text-purple-500 bg-gray-200" type="radio"
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="form-radio text-yellow-500 bg-gray-200" type="radio"
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="form-radio text-green-500 bg-gray-200" type="radio"
                                        name="radio-direct" value="3">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="form-radio text-red-500 bg-gray-200" type="radio"
                                        name="radio-direct" value="3">
                        ...
                        <div class="inline-flex font-normal  text-sm items-center">
                            <input type="checkbox" class="bg-gray-200 rounded-md" checked>
